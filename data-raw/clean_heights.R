...
old_heights <-
  read_csv('data-raw/old-data/tapioca_trait_averages.csv')
new_heights <- read_csv('data-raw/raw_trait_data/plant_heights.csv')
...
new_heights %>%
  ...
  write_csv('data-raw/temp/check_heights.csv')
